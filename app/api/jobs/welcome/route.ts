 ...
 *
 * Registered in vercel.json. The schedule is the *resolution* of the delay,
 * not the delay: a DM due at ten minutes goes out on the first sweep at or
 * after that mark, so a five-minute cron means "ten to fifteen minutes".
 *
