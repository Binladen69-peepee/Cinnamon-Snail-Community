  ...
  return (
    <div className="relative">
      ...
      {failed ? (
        ...
        >
          <span className="grid size-[4.5rem] place-items-center rounded-full bg-white/95 text-black shadow-[0_12px_34px_rgba(0,0,0,0.35)] transition group-hover:scale-105">
