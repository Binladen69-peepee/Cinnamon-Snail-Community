          ...
          {open ? (
            <div className="mt-2 flex items-center justify-end gap-1.5 border-t border-border pt-2">
              ...
              <button
                ...
                className="inline-flex h-8 min-w-16 items-center justify-center gap-1.5 rounded-full bg-forest px-3.5 text-[12.5px] font-bold text-paper transition active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-40 hover:bg-deep-forest "
              >
                {pending ? (
                  <>
